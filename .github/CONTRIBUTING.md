...
4. Make your changes
5. Run `pnpm format && pnpm build` to run ESLint/Prettier, build and tests
6. [Submit a pull request](https://github.com/NanoForge-dev/actions/compare) (Make sure you follow the [conventional commit format](https://github.com/NanoForge-dev/actions/blob/main/.github/COMMIT_CONVENTION.md))
